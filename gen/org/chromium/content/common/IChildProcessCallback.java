 ...
 * Original file: /home/ubbvand2/Himanshu/ProjectSpace/AmShellActivity/src/org/chromium/content/common/IChildProcessCallback.aidl
 */
...
int _arg1;
_arg1 = data.readInt();
android.view.Surface _result = this.getSurfaceTextureSurface(_arg0, _arg1);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
@Override public android.view.Surface getSurfaceTextureSurface(int primaryId, int secondaryId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.view.Surface _result;
...
public android.view.Surface getSurfaceTextureSurface(int primaryId, int secondaryId) throws android.os.RemoteException;
}
